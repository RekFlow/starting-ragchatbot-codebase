...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get complete course outline including title, course link, instructor, and all lessons with their numbers and titles. Use this for questions asking about course structure, syllabus, or 'what does the course cover'.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
                        "type": "string",
                        "description": "Course title or partial name (e.g. 'MCP', 'Introduction', 'RAG')"
                    }
                },
    ...
    def _format_outline(self, outline: Dict[str, Any]) -> str:
        """Format course outline for AI consumption"""
        result = []

        # Add course title and link
        result.append(f"Course: {outline['course_title']}")
        ...
        if lessons:
            ...
            for lesson in lessons:
                ...
                result.append(f"  Lesson {lesson_num}: {lesson_title}")
        else:
            result.append("\nNo lessons found.")
